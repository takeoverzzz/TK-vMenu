...
#pragma warning restore CS0649 // remove warnings
        ...
        private void CreateMenu()
        {
            ...
            MenuCheckboxItem leadCam = new MenuCheckboxItem("Enable lead camera", "Main camera, behaviour dependant on angular velocity of the car.", false);
            // Enabling chase cam
            MenuCheckboxItem chaseCam = new MenuCheckboxItem("Enable chase camera", "Locks to a target in front, switches to regular cam if target not in range.", false);
            // Enabling chase cam
            MenuCheckboxItem droneCam = new MenuCheckboxItem("Enable drone camera", "Free drone camera to spectate/fly around. Different modes available.", false);
            #endregion
